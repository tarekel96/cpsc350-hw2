...
int Doughnut::calculateNumberOfNeighbors(int row, int col, Doughnut &currentGrid){
  ...
  if(row == 0 && col == 0){
    ...
    if(currentGrid.board[row][currentGrid.getColumns() - 1].getOccupied()) count++;
    if(currentGrid.board[row + 1][currentGrid.getColumns() - 1].getOccupied()) count++;
    if(currentGrid.board[currentGrid.getRows() - 1][col].getOccupied()) count++;
    if(currentGrid.board[currentGrid.getRows() - 1][col + 1].getOccupied()) count++;
    if(currentGrid.board[currentGrid.getRows() - 1][currentGrid.getColumns() - 1].getOccupied()) count++;
  }
  /* TOP RIGHT CASE */
    ...
    if(currentGrid.board[row + 1][col].getOccupied()) count++;
    if(currentGrid.board[row + 1][col - 1].getOccupied()) count++;
    if(currentGrid.board[row][0].getOccupied()) count++;
    if(currentGrid.board[row + 1][0].getOccupied()) count++;
    if(currentGrid.board[currentGrid.getRows() - 1][0].getOccupied()) count++;
    if(currentGrid.board[currentGrid.getRows() - 1][col].getOccupied()) count++;
    if(currentGrid.board[currentGrid.getRows() - 1][col - 1].getOccupied()) count++;
  }
  /* BOTTOM LEFT CASE */
  else if(row == currentGrid.getRows() - 1 && col == 0){
    if(currentGrid.board[0][col].getOccupied()) count++;
    if(currentGrid.board[row - 1][col].getOccupied()) count++;
    if(currentGrid.board[row - 1][col + 1].getOccupied()) count++;
    if(currentGrid.board[row][col + 1].getOccupied()) count++;
    if(currentGrid.board[0][col + 1].getOccupied()) count++;
    if(currentGrid.board[0][currentGrid.getColumns() - 1].getOccupied()) count++;
    if(currentGrid.board[row][currentGrid.getColumns() - 1].getOccupied()) count++;
    if(currentGrid.board[row - 1][currentGrid.getColumns() - 1].getOccupied()) count++;
  }
  /* BOTTOM RIGHT CASE */
  else if(row == currentGrid.getRows() - 1 && col == currentGrid.getColumns() - 1){
    if(currentGrid.board[0][0].getOccupied()) count++;
    if(currentGrid.board[row - 1][col].getOccupied()) count++;
    if(currentGrid.board[row - 1][col - 1].getOccupied()) count++;
    if(currentGrid.board[row][col - 1].getOccupied()) count++;
    if(currentGrid.board[row][0].getOccupied()) count++;
